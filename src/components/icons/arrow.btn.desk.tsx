...
interface ArrowBtnDeskIconProps extends SVGProps< SVGSVGElement > {};

const ArrowBtnDeskIcon: FC< ArrowBtnDeskIconProps > = ({ className }) => {
...
export default ArrowBtnDeskIcon;